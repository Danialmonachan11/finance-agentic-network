...
| Diagram | Type | Shows |
|---|---|---|
| `architecture` | architecture | Target components from the PRD, trust boundary, what exists in `src/` today |
| `status-inquiry` | sequence | One "where is my payment" email answered with zero human touches |
