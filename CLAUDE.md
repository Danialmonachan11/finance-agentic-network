...
**Read `docs/prd.md` first, then `BRAIN.md`, then `ROADMAP.md`, every session.** `docs/builder-guide.md` explains why each component exists; update it when a component changes shape. The PRD is the
